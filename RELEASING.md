...
- Re-create the CLDF dataset:
  ```shell
  cldfbench makecldf --glottolog-version v5.2 cldfbench_birchall_et_al2016.py --with-zenodo --with-cldfreadme
  ```
...
- Run Phlorest-specific checks on the data:
  ```shell
  phlorest check --with-R cldfbench_birchall_et_al2016.py
  ```
...
- Create the release instruction:
  ```shell
  phlorest release cldfbench_birchall_et_al2016.py vX.Y
  ```
